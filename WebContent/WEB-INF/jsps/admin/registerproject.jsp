	...
	<section class="principal">
			...
			<div id="steps">
				...
				<table id="adminIzq">
					...
					<tr class="desplegable">
						<td>
							<ul class="navegador">
								<li class="ok">1. <s:text name="text.index.left.1" />
								</li>
								<li class="actual">2. <s:text name="text.index.left.2" />
								</li>
		...
		<article id="right" class="contenido">
			<div id="registerManager">
				...
				<s:form id="registerProject" class="contact_form"
					action="CreationProject" method="post">
					<s:textfield id="register" key="text.project.name"
						name="nameProjectRegister" required="true" tabindex="6" />
					<s:textfield id="register" key="text.project.date"
						name="dateProjectRegister" required="true" tabindex="7"
						value="%{#date}" />
					<s:textfield id="register" key="text.project.manager"
						name="managerProjectRegister" required="true" tabindex="8"
						value="%{#managerName}" />
					<s:textfield id="register" key="text.project.email"
						name="emailProjectRegister" required="true" tabindex="9"
						value="%{#managerEmail}" />
					<s:hidden name="stepProjectRegister" value="2" />
					<s:submit id="submitRegister" key="text.project.submit"
						name="submitRegister" tabindex="11" />
				</s:form>
			</div>
			...
			<s:a id="newmanager" action="Interceptor">
				<s:text name="new.manager" />
			</s:a>
		</article>
	</section>
