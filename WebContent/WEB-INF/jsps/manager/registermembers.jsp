	...
	<section class="principal">
					...
					<tr class="desplegable">
						<td>
							<ul class="navegador">
								...
								<li class="ok">2. <s:text name="text.index.left.2" />
								</li>
								<li class="actual">3. <s:text name="text.index.left.3" />
								</li>
								<li>4. <s:a action="RiskSystem" tabindex="5">
										<s:text name="text.index.left.4" />
									</s:a></li>
		...
		<article id="right" class="contenido">
			<div id="registerManager">
				<h2 id="managerDch">
					<s:text name="text.register.member" />
				</h2>

				<s:set var="managerIdProject">${sessionScope.usuario.getIdProyecto()}</s:set>

				<s:form id="registerMember" class="contact_form"
					action="RegisterMember" method="post">
					<s:textfield id="register" key="text.regiter.project"
						name="projectRegister" required="true"
						value="%{#managerIdProject}" tabindex="6" />
					<s:textfield id="register" key="text.register.nombre"
						name="loginRegister" required="true" tabindex="7" />
					<s:textfield id="register" key="text.regiter.email"
						name="emailRegister" required="true" tabindex="8" />
