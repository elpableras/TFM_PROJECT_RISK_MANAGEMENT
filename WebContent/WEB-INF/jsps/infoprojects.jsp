				...
				<table>
					...
					<s:iterator id="infoproject"
						...
						<tr>
							...
							<td>
								<s:form id="options" action="OptionProject" method="post" theme="simple">								
									...
									<s:submit id="submitOptions" key="tabla.infoproject.update" name="submitOptions" tabindex="6" />
								</s:form>
							</td>
							<td>
								<s:form id="options" action="OptionProject" method="post" theme="simple">								
									<s:hidden name="delete" value="%{id}" /> 
									<s:submit id="submitOptions" key="tabla.infoproject.delete" name="submitOptions" tabindex="6" />
								</s:form>
							</td>						
						</tr>
					</s:iterator>
				...
				<table>
					...
					<s:iterator id="infomanager"
						...
						<tr>
							...
							<td><s:property value="modify" /></td>
							<td>
								<s:form id="options" action="OptionManager" method="post" theme="simple">								
									<s:hidden name="updateId" value="%{id}" />
									<s:hidden name="updateLogin" value="%{login}" />
									<s:hidden name="updateEmail" value="%{email}" />
									<s:hidden name="updateIdProject" value="%{idProyecto}" /> 
									<s:submit id="submitOptions" key="tabla.infoproject.update" name="submitOptions" tabindex="7" />
								</s:form>
							</td>
							<td>
								<s:form id="options" action="OptionManager" method="post" theme="simple">								
									<s:hidden name="delete" value="%{id}" /> 
									<s:submit id="submitOptions" key="tabla.infoproject.delete" name="submitOptions" tabindex="7" />
								</s:form>
							</td>
						</tr>
					</s:iterator>
