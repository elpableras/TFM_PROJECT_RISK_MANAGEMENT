    						...
    						<td>
  								<ul>   									
									...
									<s:else>																				
										...
										<li class="steps"> 3 <s:a action="RiskRespManagement" tabindex="6"><s:text name="text.index.left.4.4"/></s:a></li>
										<li class="steps"> 4 <s:a action="LoadPDF" tabindex="7"><s:text name="text.index.left.4.5"/></s:a></li>
									</s:else>																		     										  												
								</ul>
							</td>    													
			...
			<s:if test='%{#play == 3}'>
				<div id="member">
					<h2 id="riskM"><s:text name="text.resp"/></h2>								
	   				...
	   				<table id="riskM">
	   					<tr>
	   						<th><s:text name="text.resp.right"/> ${applicationScope.corte}</th>
	   					</tr>
	   					<tr>
	   						<td>
	   							<ul class="navegador">
