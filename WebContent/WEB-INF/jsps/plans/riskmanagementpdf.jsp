    						...
    						<td>
    							<ul class="navegador"> 
    								...
    								<s:iterator value="%{#application.study}"> 
    									<s:set var="nombreResp"><s:text name="pdf.resp"/></s:set>
    								   	<s:set var="nombreResp">${nombreResp} ${nombre}</s:set>
				       					<li class="steps" id="PDFRisk"><s:a action="CreatePDF" tabindex="7"><s:text name="pdf.resp"/> <s:property value="nombre"/><s:param name="option" value="3" /><s:param name="num" value="%{#numRisk}" /><s:param name="title" value="%{#nombreResp}" /></s:a></li>				       					
